...
export const chatbotKnowledge: ChatbotKnowledge[] = [
  // Company Info
  {
    ...
    response: "Mides Global Realtors is a trusted real estate company in Lagos, founded by Anu. We specialize in property sales, rentals, and management with a focus on integrity, transparency, and exceptional customer service."
  },
  {
    keywords: ["Anu", "ceo", "founder", "owner", "who is anu"],
    response: "Anu is the founder and lead realtor at Mides Global Realtors. With over 5 years of experience in Lagos real estate, she personally guarantees personalized service, expert knowledge, and seamless transactions for all clients."
  },
  ...
  },
  {
    ...
    response: "Yes! We help clients purchase properties across Lagos including Lekki, VI, Ikoyi, Ajah, Ibeju Lekki, and more. Would you like to see our current listings or speak with Anu for personalized assistance?"
  },
  {
    keywords: ["rent", "lease", "rental", "apartment", "renting"],
    response: "Absolutely! We offer rental properties including flats, apartments, and houses in prime locations. Our rental process is transparent and hassle-free. Want to discuss your rental needs with Anu?"
  },
  ...
  },
  {
    ...
    response: "We have beautiful homes available including duplexes, bungalows, and luxury villas in Lekki, Ikoyi, Ajah, and VI. Would you like to schedule a viewing with Anu?"
  },
  {
  ...
  // Contact - Expanded
  {
    ...
    response: "You can reach us at: 📞 0903 358 1493 or 0816 469 0627, 📧 info@midesglobalrealtors.com, 📍 Thomas Estate, Ajah, Lagos. Click the WhatsApp button to chat instantly with Anu!"
  },
  ...
  // Hours
  {
    ...
    response: "We're available Monday to Saturday, 9 AM to 6 PM. You can also reach Anu on WhatsApp anytime for urgent inquiries!"
  },
  
  // Specific property inquiries
  {
    keywords: ["viewing", "tour", "inspect", "see property", "visit"],
    response: "To schedule a property viewing, please contact Anu directly on WhatsApp. She'll arrange a convenient time for you to visit any property you're interested in.",
    redirectWhatsApp: true
  },
  {
    keywords: ["negotiate", "discount", "offer", "price negotiable"],
    response: "For price negotiations or special offers, it's best to speak directly with Anu. Click the WhatsApp button below to discuss pricing and possible discounts!",
    redirectWhatsApp: true
  },
  {
    keywords: ["document", "legal", "title", "c of o", "deed", "paperwork"],
    response: "For specific document inquiries and legal verification, please contact Anu directly. She'll provide all necessary documentation and guide you through the legal process.",
    redirectWhatsApp: true
  }
];

export const fallbackResponse = "I want to help you find your perfect property! For personalized assistance, please click the WhatsApp button below to chat directly with Anu. She'll answer all your questions about properties, pricing, and viewings. 🏠💚";
